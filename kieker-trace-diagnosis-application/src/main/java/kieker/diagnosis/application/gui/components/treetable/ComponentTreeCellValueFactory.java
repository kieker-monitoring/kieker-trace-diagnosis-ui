 ...
 */
public final class ComponentTreeCellValueFactory implements Callback<CellDataFeatures<?, String>, ObservableValue<String>>, AutowireCandidate {

	private static final Logger cvLogger = LoggerFactory.getLogger( ComponentTreeCellValueFactory.class );
	...
	public ObservableValue<String> call( final CellDataFeatures<?, String> aCall ) {
		try {
			...
			if ( ivPropertiesService.loadApplicationProperty( ComponentNamesProperty.class ) == ComponentNames.SHORT ) {
