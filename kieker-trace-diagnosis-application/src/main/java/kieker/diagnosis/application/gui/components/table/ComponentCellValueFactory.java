 ...
 */
public final class ComponentCellValueFactory implements Callback<CellDataFeatures<?, String>, ObservableValue<String>>, AutowireCandidate {

	private static final Logger cvLogger = LoggerFactory.getLogger( ComponentCellValueFactory.class );
