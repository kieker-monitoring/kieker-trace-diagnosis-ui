...
package kieker.diagnosis.application.service.data.domain;

/**
 * This class represents an aggregated operation call within this application. It adds some properties that are only available due to aggregation, like the
...
public final class AggregatedOperationCall extends AbstractOperationCall<AggregatedOperationCall> {
	...
	public AggregatedOperationCall( final String aContainer, final String aComponent, final String aOperation, // NOPMD (a long parameter list cannot be
																												// avoided)
			final String aFailedCause, final long aTotalDuration, final long aMedianDuration, final long aMinDuration, final long aMaxDuration,
			final long aMeanDuration, final int aCalls ) {
