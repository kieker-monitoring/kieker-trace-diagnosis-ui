...
public class DatabaseBeforeEventRecord extends DatabaseEventRecord  {
	...
	public static final int SIZE = TYPE_SIZE_STRING // IOperationSignature.operationSignature
			 ...
			 + TYPE_SIZE_STRING // DatabaseBeforeEventRecord.returnValue
			 + TYPE_SIZE_STRING // DatabaseBeforeEventRecord.callArgs
	;
	private static final long serialVersionUID = -6442021138678317567L;
	...
	public static final Class<?>[] TYPES = {
		...
		String.class, // DatabaseBeforeEventRecord.returnValue
		String.class, // DatabaseBeforeEventRecord.callArgs
	};
	 ...
	 *            callArgs
	 */
	public DatabaseBeforeEventRecord(final String operationSignature, final String classSignature, final String calleeOperationSignature, final String calleeClassSignature, final int objectId, final int calleeObjectId, final long timestamp, final String returnValue, final String callArgs) {
	 ...
	 */
	public DatabaseBeforeEventRecord(final Object[] values) { // NOPMD (direct store of values)
		super(values, TYPES);
	 ...
	 */
	protected DatabaseBeforeEventRecord(final Object[] values, final Class<?>[] valueTypes) { // NOPMD (values stored directly)
	 ...
	 */
	public DatabaseBeforeEventRecord(final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
