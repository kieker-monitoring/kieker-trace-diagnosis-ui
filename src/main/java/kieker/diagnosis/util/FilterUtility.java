...
public final class FilterUtility {
	...
	public static <T extends AbstractOperationCall<T>> Predicate<T> useFilter( final TextField aFilter, final Function<T, String> aFunction,
	...
	public static <T extends AbstractOperationCall<T>> Predicate<T> useFilter( final DatePicker aDatePicker, final Function<T, Long> aFunction,
	...
	public static <T extends AbstractOperationCall<T>> Predicate<T> useFilter( final CalendarTimeTextField aTimeTextField, final Function<T, Long> aFunction,
			final boolean aFilterBefore, final boolean aSearchInChildren ) {
