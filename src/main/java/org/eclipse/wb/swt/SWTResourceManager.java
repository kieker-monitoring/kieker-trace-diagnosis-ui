 ...
 *******************************************************************************/
package org.eclipse.wb.swt; // NOPMD
 ...
 * <p>
 * !!! IMPORTANT !!! Application code must explicitly invoke the <code>dispose()</code> method to release the operating system resources managed by cached objects
 * when those objects and OS resources are no longer needed (e.g. on application shutdown)
 * <p>
 ...
 * @author Dan Rubel
 */
public class SWTResourceManager { // NOPMD
	// //////////////////////////////////////////////////////////////////////////
	//
	// Color
	//
	// //////////////////////////////////////////////////////////////////////////
	private static Map<RGB, Color> m_colorMap = new HashMap<RGB, Color>(); // NOPMD
	 ...
	 */
	private static Map<String, Image> m_imageMap = new HashMap<String, Image>(); // NOPMD
	...
	protected static Image getImage(final InputStream stream) throws IOException {
		try {
			...
			if (data.transparentPixel > 0) { // NOPMD
	...
	private static final int MISSING_IMAGE_SIZE = 10; // NOPMD

	/**
	 * @return the small {@link Image} that can be used as placeholder for missing image.
	 */
	private static Image getMissingImage() {
		final Image image = new Image(Display.getCurrent(), SWTResourceManager.MISSING_IMAGE_SIZE, SWTResourceManager.MISSING_IMAGE_SIZE);
		//
	 ...
	 */
	public static final int TOP_LEFT = 1; // NOPMD
	/**
	 * Style constant for placing decorator image in top right corner of base image.
	 */
	public static final int TOP_RIGHT = 2; // NOPMD
	/**
	 * Style constant for placing decorator image in bottom left corner of base image.
	 */
	public static final int BOTTOM_LEFT = 3; // NOPMD
	/**
	 * Style constant for placing decorator image in bottom right corner of base image.
	 */
	public static final int BOTTOM_RIGHT = 4; // NOPMD
	/**
	 * Internal value.
	 */
	protected static final int LAST_CORNER_KEY = 5; // NOPMD
	/**
	 * Maps images to decorated images.
	 */
	@SuppressWarnings("unchecked")
	private static Map<Image, Map<Image, Image>>[] m_decoratedImageMap = new Map[SWTResourceManager.LAST_CORNER_KEY]; // NOPMD
	...
	public static Image decorateImage(final Image baseImage, final Image decorator) {
		return decorateImage(baseImage, decorator, SWTResourceManager.BOTTOM_RIGHT);
	}
	 ...
	 */
	public static Image decorateImage(final Image baseImage, final Image decorator, final int corner) { // NOPMD
	 ...
	 */
	private static Map<String, Font> m_fontMap = new HashMap<String, Font>(); // NOPMD
	/**
	 * Maps fonts to their bold versions.
	 */
	private static Map<Font, Font> m_fontToBoldFontMap = new HashMap<Font, Font>(); // NOPMD
		...
		if (font == null) {
			...
			if (strikeout || underline) {
				try {
					...
					System.err.println("Unable to set underline or strikeout" + " (probably on a non-Windows platform). " + e); //$NON-NLS-1$ //$NON-NLS-2$  // NOPMD
				}
			}
	 ...
	 * Maps IDs to cursors.
	 */
	private static Map<Integer, Cursor> m_idToCursorMap = new HashMap<Integer, Cursor>(); // NOPMD
