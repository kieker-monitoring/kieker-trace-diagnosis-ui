...
/**
 * This is a unit test for {@link TraceDepthAggregator}.
 *
 * @author Nils Christian Ehmke
 */
public final class TraceDepthAggregatorTest {

	@Test
	public void testAggregationOnEmptyList( ) {
		final Aggregator aggregator = new TraceDepthAggregator( 1 );
	...
	public void testRealAggregation( ) {
		...
		assertThat( aggregationMethodCall.getTraceDepth( ) ).isEqualTo( 2 );
	}
