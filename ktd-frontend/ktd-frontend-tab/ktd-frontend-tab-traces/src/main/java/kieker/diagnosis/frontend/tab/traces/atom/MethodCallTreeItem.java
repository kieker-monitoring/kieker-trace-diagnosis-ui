...
/**
 * This is an item for a tree table, which contains a method call. The children are loaded in a lazy way. The item
 * enriches and aggregates the children based on the current application settings.
 *
