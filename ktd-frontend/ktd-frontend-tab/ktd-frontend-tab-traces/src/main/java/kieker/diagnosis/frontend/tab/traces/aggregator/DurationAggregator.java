...
/**
 * This aggregator aggregates method calls by duration. That means that method calls in a trace with lower duration are
 * aggregated into a single method call.
 *
