...
/**
 * This aggregator aggregates method calls by trace size. That means that method calls in a trace with lower trace size
 * are aggregated into a single method call.
 *
