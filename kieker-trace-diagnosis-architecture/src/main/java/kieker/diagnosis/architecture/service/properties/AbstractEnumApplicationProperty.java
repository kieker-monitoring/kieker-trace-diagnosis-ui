 ...
 */
public abstract class AbstractEnumApplicationProperty<T extends Enum<T>> implements ApplicationProperty<T> {

	private final Class<T> ivEnumClass;

	public AbstractEnumApplicationProperty( final Class<T> aEnumClass ) {
